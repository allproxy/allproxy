...
The **anyproxy-ca** script is provided to install the CA certificate in your browser so it is trusted.  If your browser still does not trust certificates generated by AllProxy, manually import **ca.pem** (in root directory) to your browser.
